package com.microcontrolador.main;
...
import com.microcontrolador.conexao.Conexao;
import com.microcontrolador.model.ComunicacaoMaquina;
import com.microcontrolador.reports.GeraRelatorio;
import com.microcontrolador.service.MaquinaService;
...
public class ComunicacaoMaquinaFrame extends JFrame {
	...
	private JButton btnFecharTampa;
	...
	private void fecharTampa(ActionEvent e) {
		Thread tarefa = new Thread() {
			String c="Q";
	...
	private void abrirTampa(ActionEvent e) {
		Thread tarefa = new Thread() {
			String c="T";
			...
			public void run() {
				if(estados != 0) {
			          conexao.sendData(c);
			          txtEstado.setText("Tampa aberta");
			          try {
			        	  Thread.sleep(10000);
			          }catch (InterruptedException e) {
					}
	...
	public void atualizaLabel(int estadoAtual) {
		estados = estadoAtual;
		atualizaLabel();
	}
	...
	private void initComponents() {
		...
		layeredPane_1.add(btnDesliga);
		 ...
		 button = new JButton("Abrir Tampa");
		 button.addActionListener(new ActionListener() {
		 	public void actionPerformed(ActionEvent e) {
		 		abrirTampa(e);
		 	}
		 });
		 button.setBounds(111, 215, 110, 23);
		 layeredPane_1.add(button);
		 
		 btnFecharTampa = new JButton("FecharTampa");
		 btnFecharTampa.addActionListener(new ActionListener() {
		 	public void actionPerformed(ActionEvent e) {
		 		fecharTampa(e);
		 	}
		 });
		 btnFecharTampa.setBounds(234, 215, 120, 23);
		 layeredPane_1.add(btnFecharTampa);
		 ...
		 btnAtualiza.setBounds(332, 67, 89, 23);
		 layeredPane_1.add(btnAtualiza);
